...
static const unsigned int gappiv    = 20; /* Vertical inner gap between windows */
static const unsigned int gappoh    = 20; /* Horizontal outer gap between windows */
static const unsigned int gappov    = 20; /* Vertical outer gap between windows */
static const int smartgaps          = 1;  /* 1 is for no outer gaps when there is only one window */
...
static const char col_cyan[]        = "#4da1ae";
static const char col_baby_blue[]   = "#90dce8";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_cyan,  col_baby_blue  },
};
